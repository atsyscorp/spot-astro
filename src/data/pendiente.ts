/* Desde el 18/09/2026 la línea Industrial sí tiene material propio: el
   ...
   `industrial.ts`, incluido el muro de clientes de la página 25. Lo que el
   catálogo no contiene —casos con resultado verificable— se queda aquí. Este archivo
...
export const materialFaltante = [
  'Logotipos de cliente en vectorial, de las dos pistas. Los del portafolio y los del catálogo industrial están incrustados como raster dentro de sus PDF, a resolución de pantalla.',
